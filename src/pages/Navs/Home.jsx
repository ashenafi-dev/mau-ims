...
const keyPoints = [
  ...
  },
  {
    ...
    description:
      "Protect your data with robust security measures, ensuring only authorized access and safeguarding sensitive information.",
  },
  {
    icon: analyticsIcon,
    title: "Comprehensive Analytics",
    description:
      "Gain valuable insights with detailed analytics and reporting tools to make informed decisions and optimize your inventory management.",
  },
];
